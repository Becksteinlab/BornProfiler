...
"""
usage = """%prog dat_files --xcolumn --ycolumn --title --xlabel --ylabel --plot_labels --colors --file_title --better_labels --seaborn
Produces a matplotlib.pyplot plot of the data of the xcolumn vs the data of the ycolumn from a column-orgranized dat file with the labels, colors, and title. Defaults set for apbs analysis of energy vs z coordinate. Saves to a png and pdf of the title provided in file_title. better_labels compares submitted plot_labels to a list of standard ions and replaces them with strings containing charge and bonding information. seaborn turns on better plotting via the seaborn module."""
import bornprofiler
import argparse
import logging
import matplotlib
